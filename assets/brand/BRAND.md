...
| File | Use |
|------|-----|
| `logo.png` | Primary full logo (web, presentations, social) |
| `logo-mark.svg` | App icon, favicon source, avatars, compact layouts |
...
| File | Use |
|------|-----|
| `assets/templates/business-card.html` | Print-ready 3.5×2 in card |
| `assets/templates/letterhead.html` | A4 letterhead for proposals & contracts |

## Configuration

Edit contact details in `assets/brand/site-config.js` before printing or publishing.
